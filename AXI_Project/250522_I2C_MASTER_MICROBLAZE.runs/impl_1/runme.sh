...
HD_PWD='C:/fpga_harman/250522_I2C_MASTER_MICROBLAZE/250522_I2C_MASTER_MICROBLAZE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_LITE_I2C_PERIPH_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AXI4_LITE_I2C_PERIPH_wrapper.tcl -notrace
