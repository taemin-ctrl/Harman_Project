...
HD_PWD='C:/fpga_harman/250522_I2C_MASTER_MICROBLAZE/250522_I2C_MASTER_MICROBLAZE.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_LITE_I2C_PERIPH_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI4_LITE_I2C_PERIPH_wrapper.tcl
